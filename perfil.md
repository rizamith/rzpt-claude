# Perfil do atleta — Ricardo Zamith

Consolidado a partir dos três relatórios importados de `import/` (Notebook Google), em
2026-08-06. **Fonte secundária:** são relatórios narrativos, não registos primários. Os valores
marcados com ⚠️ são inconsistentes ou não confirmados — não usar em análises sem confirmação.
...
### Contexto: nadador federado de longa data

**Melhor de sempre absoluto: 100 Livres em 53.30, piscina de 50 m, em 2001, aos 25 anos.**
Não é um praticante amador — é um nadador competitivo com 25 anos de acumulação técnica.
Isto sustenta a tese do próprio atleta: o motor e a técnica existem; o que limita é a massa.

### Alvos — **ambas as provas alvo são em piscina de 50 m**

Confirmado 2026-08-07: nacionais de março **e** de julho de 2027 são em piscina longa.
Toda a calibração passa a ser em 50 m — os tempos de 25 m servem de indicador, nunca de alvo.

| Prova (50 m) | Melhor de sempre | Quando | Atual 2026 | Alvo março 2027 |
| --- | --- | --- | --- | --- |
| 50 Bruços | **33.64** | jul/2023 (47 a) | ⚠️ sem tempo desde jun/2025 (33.68) | regressar a ~33.5 |
| 50 Livres | **26.60** | jan/2024 (48 a) | 27.36 | regressar a ~26.6 |
...
## Divisão de responsabilidades _(definida pelo atleta, 2026-08-07)_

> "Preocupa-te com o meu peso, eu trato do resto. Se me puseres com 90 kg eu voo na água."

| Ricardo trata | O PT trata |
| --- | --- |
| Técnica, partidas, viragens, pullout | **Peso e composição corporal** |
| Planeamento das sessões de natação | Nutrição e orçamento calórico |
| Escolha de provas e calendário | Sono, recuperação, gestão de carga |
| | Análise de dados e deteção de tendências |

**Não escrever planos de treino de natação.** Os tempos registam-se e analisam-se como
_medição do efeito do peso_ — é assim que se verifica se o plano nutricional está a funcionar.

## Histórico ponderal (Fev–Jun 2026)

| Data | Peso (kg) | Contexto |
| --- | --- | --- |
| Fevereiro 2026 | 102.0 | Início dos registos |
| 17/03/2026 | 100.8 | Mínimo histórico |
| 13/04/2026 | 103.8 | Pico pós-excesso |
...
- **06h15–06h30, pré-treino:** L-Carnitina + termogénico
- **Pós-treino:** 40 g proteína de ervilha + banana + 5 g creatina
- Os relatórios são contraditórios sobre o termogénico: um manda cessá-lo, os outros mantêm-no
  pré-treino ⚠️. **Ver alerta clínico abaixo.**

## Alertas clínicos a resolver antes de qualquer plano

1. **Termogénico + escitalopram + tinnitus + ansiedade crónica.** Estimulantes neste quadro
   agravam ansiedade e zumbido, e há interação a considerar com um ISRS. Isto é conversa para
   o médico, não para um coach.
2. **Auto-ajuste do Cipralex.** Correto o que dizem os relatórios: a dose fixa-se com o médico.
3. **Contradição de fundo:** a prova de 11/07 incluía **100 Bruços**, e bruços está listado como
   proibição absoluta pelo edema do ombro. Os relatórios nunca resolvem isto.
4. **Tom dos relatórios.** "Suicídio metabólico", "executa ou falha", "atleta amador". Num quadro
   de ansiedade crónica, abordagens baseadas em vergonha alimentam exatamente o ciclo
   restrição→compensação que os relatórios diagnosticam. O diagnóstico do padrão está certo; o
   método de o corrigir, não.
