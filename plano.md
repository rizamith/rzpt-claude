# Plano — Agosto 2026 → Julho 2027

Escrito 2026-08-06. Alvo final: **campeão nacional masters +50 em natação**, com 89.9 kg em
julho 2027 e 92 kg nos nacionais de março 2027. Perfil e restrições em [perfil.md](perfil.md).

**Princípio que manda em tudo:** a natação decide. O CrossFit/Hyrox é reforço muscular e prazer —
quando as duas coisas colidirem em carga ou fadiga, cede o CrossFit.

---

## 1. Ponto de partida e o diagnóstico do planalto

| | |
| --- | --- |
| Peso 11/07/2026 (dia da prova) | 100.1 kg |
| Peso 06/08/2026 | 100.0 kg |
| **Variação em 26 dias** | **−0.1 kg → planalto** |

Os −4.7 kg de junho foram feitos nas três semanas antes da prova. Desde 11/07 o peso está
parado. Não é falta de esforço à semana — é aritmética de fim de semana.

### Balanço energético real

- **TMB medida (balança):** 1932 kcal
- **TMB calculada (Mifflin-St Jeor, 50 a / 185 cm / 100 kg / M):** 1911 kcal
- Dois métodos independentes a 1 % de distância → planeamos com **~1920 kcal**
- Com 6 sessões semanais + trabalho sentado: **gasto diário ~2880 kcal** (~20 160 kcal/semana)

### Onde o défice desaparece (estimativas)

| Evento | Custo estimado |
| --- | --- |
| 2 garrafas de vinho / semana | ~1200 kcal |
| Francesinha + batatas + 2 cervejas | ~2200 kcal |
| Sushi comercial (~20 peças) | ~800 kcal |
| Almoço de família com pão e sobremesa | ~1800 kcal |

Três dias seguidos de excesso (6ª, sáb, dom) somam facilmente **+2500 a 3500 kcal acima** do que
somariam três dias normais. Um défice de 500 kcal/dia de 2ª a 5ª banca 2000 kcal. **O fim de
semana apaga a semana inteira — e sobra.** É isto, e só isto, o planalto.

---

## 2. A solução: repartir a semana em vez de a restringir

Não corto a francesinha, não corto o sushi, não corto o vinho. Contamos.

Para perder **0.25 kg/semana** preciso de um défice de ~2000 kcal/semana — ou seja, comer
~18 200 kcal em vez de 20 160.

| Dia | Treino | kcal alvo |
| --- | --- | --- |
| 2ª | CrossFit | 2400 |
| 3ª | Natação | 2400 |
| 4ª | CrossFit | 2400 |
| 5ª | Natação | 2400 |
| 6ª | CrossFit + **sushi e vinho** | 2900 |
| Sábado | Natação + **francesinha e cerveja** | 3200 |
...
| Macro | Alvo | Porquê |
| --- | --- | --- |
| Proteína | **180 g** | 1.8 g/kg. Aos 50 anos, em défice, é o que protege os 72.3 kg de massa magra |
| Hidratos | **~250 g** | Concentrados em volta do treino |
| Gordura | **~75 g** | Mínimo hormonal; não descer abaixo de 0.8 g/kg |

**250 g de hidratos contra os ~28 g que o plano antigo prescrevia.** É a mudança que faz o resto
funcionar: com glicogénio cheio, a fome de sexta-feira desaparece sozinha.

### As seis alterações concretas

1. **Coca-Cola do almoço → zero/diet**, se ainda não for. Uma lata normal por dia são ~1000
   kcal/semana invisíveis. É a correção mais barata que existe.
2. **Francesinha sem as batatas.** ~450 kcal de nada. O prazer é a francesinha, as batatas são
   automatismo.
3. **Sushi: metade em sashimi/sabores limpos.** Sem rolos fritos, sem molhos doces. Poupa ~400
   kcal e quase todo o sódio — que é o que te faz pesar +1.5 kg no sábado sem ter engordado.
4. **Almoço de domingo: sem cesto do pão e sem sobremesa.** Proteína, legumes, uma dose de
   hidratos. O almoço mantém-se.
5. **Vinho fica nas 2 garrafas**, distribuídas 6ª + sábado, contadas no orçamento. Não é para
   cortar — é para não virar 3.
6. **Os "gins" falsos ficam exatamente como estão.** Estão a funcionar, não se mexe.

---

## 3. Trajetória de peso

Milestone mensal, sempre em **média de 7 dias** — nunca o valor de um dia.

| Fim de | Alvo | Notas |
| --- | --- | --- |
| Ago 2026 | 99.0 kg | Sair do planalto. Primeiro mês com dados a sério |
| Set 2026 | 97.7 kg | |
| Out 2026 | 96.4 kg | |
| Nov 2026 | 95.1 kg | |
| Dez 2026 | 94.5 kg | **Travão deliberado** — Natal + aniversário (18/12). Manter, não perder |
| Jan 2027 | 93.2 kg | |
| Fev 2027 | 92.0 kg | |
| **Mar 2027** | **92.0 kg** | **Nacionais.** Sem défice na semana da prova — manter e afinar |
| Abr 2027 | 91.0 kg | |
| Mai 2027 | 90.4 kg | |
| Jun 2027 | 90.2 kg | |
| **Jul 2027** | **89.9 kg** | **Nacionais de verão** |

Ritmo: 0.27 kg/semana até março, depois 0.12 kg/semana. **Abranda de propósito** na segunda
metade — quanto mais magro, mais fácil é perder músculo em vez de gordura, e março a julho é
época de competição, não de emagrecimento.

### O alvo real não é o peso

Massa isenta de gordura hoje: **72.3 kg**. Se a mantivermos intacta:
...
Os 89.9 kg com 72 kg de massa magra dão ~20 % de gordura. Isso é o objetivo verdadeiro. Se
chegares a 89.9 kg com 68 kg de massa magra, falhámos — mesmo com o número certo na balança.

**É por isso que a massa muscular e a massa isenta de gordura se registam todos os dias, não só
o peso.** São elas o critério de sucesso.

---

## 4. Estrutura de treino

Matriz mantida por agora, com a hierarquia corrigida:

| Dia | Sessão | Foco |
| --- | --- | --- |
| 2ª, 4ª, 6ª | CrossFit / Hyrox | Reforço muscular, preservar massa magra em défice. **Não é competição.** |
...
contrário. Menos metcons longos, mais trabalho de força com descanso a sério.

---

## 5. Decisões de suplementação

**Termogénico pré-treino: recomendo parar.** Três razões, por ordem:

1. O contributo real para a perda de gordura, a esta escala, é próximo de zero — está tudo no
   défice de 2000 kcal/semana da secção 2.
2. Historicamente o teu tinnitus é reativo a stress do SNC, e estimulantes empurram nessa direção.
3. Estás estável em 10 mg de Cipralex e sentes-te bem. Não vale a pena introduzir uma variável
   estimulante num sistema que finalmente assentou.

A L-Carnitina é inócua — se quiseres mantê-la, mantém. **Se decidires manter o termogénico,
menciona-o ao médico**, pela combinação com o ISRS e pelo histórico de zumbido.

**Creatina: manter, 5 g/dia**, todos os dias, independentemente de treinar. É o suplemento com
melhor evidência para preservar massa magra em défice. Retém ~1 kg de água intramuscular — isso
aparece na balança e **não é gordura**; ignora-se.
